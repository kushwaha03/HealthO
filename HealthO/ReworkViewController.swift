...
class ReworkViewController: UIViewController {

    @IBOutlet weak var reworkTbl: UITableView!
...
extension ReworkViewController: UITableViewDelegate, UITableViewDataSource {
